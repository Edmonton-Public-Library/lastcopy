#!usr/bin/env awk
# Version: 1.2.1 - Added homelocation, and user_cat2 before the call number (at the end).
...
# 3) Check output:
#    REPLACE INTO last_copy_items (id, last_copy_title_id, checkouts, current_location, item_type, copy_holds, last_active, last_charged, home_location, user_cat2, call_number) VALUES 
...
BEGIN {
    ...
    insertStatement = "REPLACE INTO last_copy_items (id, last_copy_title_id, checkouts, current_location, item_type, copy_holds, last_active, last_charged, home_location, user_cat2, call_number) VALUES ";
